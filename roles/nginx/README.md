...
[![Build Status](https://travis-ci.org/unxnn/ansible-role-nginx.svg?branch=master)](https://travis-ci.org/unxnn/ansible-role-nginx)
...
Create the child template in the path you configured above and extend `unxnn.nginx` template file relative to your `playbook.yml`.

```
{% extends 'roles/unxnn.nginx/templates/nginx.conf.j2' %}
